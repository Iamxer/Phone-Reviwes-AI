...
while True:
    ...
    model.compile(optimizer=adam(learning_rate=0.00005), loss='categorical_crossentropy')
    model.fit(xTrainDiv, yTrainDiv, batch_size=50, epochs=200)
    model.save('PhoneReviewEng')